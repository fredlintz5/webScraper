			...
			`<div class="col s12 m4 l3">
			  <div class="card">
			    ...
			    <div class="card-reveal">
			      ...
			      <br>
			      <div class="center">
			      	<button class="btn center waves-effect waves-light teal lighten-1" data-id="${item._id}" id="submitRating">Submit Rating</button>
			     </div>
			    </div>
			  </div>
			</div> `
	$('#mountainInventory').append(bikeCard);
	})
}
